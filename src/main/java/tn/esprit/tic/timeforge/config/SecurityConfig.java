    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
            http
                    ...
                    .authorizeHttpRequests(auth -> auth
                        .requestMatchers("/auth/**","/api/reports/**", "/visiteur/**","/api/health-reminders/**","/api/strategic-reminders/**","/api/goals/**","/tasks/**","/api/goals/taksbygoals","/api/translate","/chat-socket/**","/users/**","/api/health-reminders/{goalId}/chronic/{activate}/**").permitAll()
